"""Continuous-time neural ODE-based model implementations."""
...
__all__ = ["ContinuousMultiStateNN"]
...
class ContinuousMultiStateNN(nn.Module, BaseMultiStateNN):
    ...
    def predict_proba(
        ...
        """
        probs = self.forward(x, time_start, time_end, from_state)
        
        # As this is already a probability matrix from the ODE solution,
        # we don't need to apply softmax like in the discrete-time model
        return probs